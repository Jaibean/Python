...
def describe_game(name):
    """
        ...
        If it is not a new game, thank the payer for
        playing again and contine with the game
    """
    # meaning, if we do not already have this user's name,
    # then they are a new player adn we need to get their name
    if name != "":
        ...
        while stop:
            if name == "":
                ...
                if name != "":
                    ...
                    print("but at the end of the game your fate \nwill be seeled by your actions.")
                    stop = False
    return name


def nice_meam(nice,mean,name):
    stop = True
    while stop:
...
def win(nice,mean,name):
    # Subsitute this {} wildcards with our variable values
...
def lose(nice,mean,name):
    ...
    print("\nAhhh too bad, game over! \m{}, you live a dirty beat-up \nvan by the river, wretched and alone!".format(name))
    again(nice,mean,name)
